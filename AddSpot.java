        ...
        addNewSpot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(valid()){
                    ...
                    if(div.equals("Bengaluru")) root.child("Spots").child("Bengaluru").push().setValue(map);
                    else if(div.equals("Mysore")) root.child("Spots").child("Mysore").push().setValue(map);
                    else if(div.equals("Darjeeling")) root.child("Spots").child("Darjeeling").push().setValue(map);
                    else if(div.equals("Hyderabad")) root.child("Spots").child("Hyderabad").push().setValue(map);
                    else if(div.equals("Chennai")) root.child("Spots").child("Chennai").push().setValue(map);
                    else if(div.equals("Shillong")) root.child("Spots").child("Shillong").push().setValue(map);
                    else if(div.equals("Jalpaiguri")) root.child("Spots").child("Jalpaiguri").push().setValue(map);
                    else if(div.equals("Ranchi")) root.child("Spots").child("Ranchi").push().setValue(map);
