            ...
            public void onClick(View v) {
                ...
                if(valid()){
                   ...
                   // map.put("purl",url);
                    ...
                    if(div.equals("Bengaluru")) root.child("Restaurants").child("Bengaluru").push().setValue(map);
                    else if(div.equals("Mysore")) root.child("Restaurants").child("Mysore").push().setValue(map);
                    else if(div.equals("Darjeeling")) root.child("Restaurants").child("Darjeeling").push().setValue(map);
                    else if(div.equals("Hyderabad")) root.child("Restaurants").child("Hyderabad").push().setValue(map);
                    else if(div.equals("Chennai")) root.child("Restaurants").child("Chennai").push().setValue(map);
                    else if(div.equals("Shillong")) root.child("Restaurants").child("Shillong").push().setValue(map);
                    else if(div.equals("Jalpaiguri")) root.child("Restaurants").child("Jalpaiguri").push().setValue(map);
                    else if(div.equals("Ranchi")) root.child("Restaurants").child("Ranchi").push().setValue(map);
